...
export function FeaturesSectionDemo() {
  ...
  return (
    <div className="pt-16 md:pt-24">
      <h2 className="text-2xl md:text-4xl font-bold text-center text-white pb-8">Why we are the best</h2>
  ...
  return (
    <div>
      ...
      >
        ...
        <p className="text-sm font-semibold  text-primary  dark:text-neutral-300 max-w-xs relative z-10 px-10">
          {description}
        </p>
      </div>
    </div>
