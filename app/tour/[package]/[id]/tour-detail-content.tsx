  ...
  if (!tourData) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="mb-8 text-white">The tour you are looking for does not exist or has been removed.</p>
        <Link href="/" className="bg-red-600 text-white py-2 px-6 rounded-md hover:bg-red-700 transition duration-300">
          Return to Home
        </Link>
      </div>
    )
    ...
    <section className="md:padding container pt-20 bg-black min-h-screen">
      <div className="mx-auto px-4 md:px-10 py-8">
        ...
        <div className="mt-4 flex justify-center flex-col text-center items-center">
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-red-500 to-red-700 text-transparent bg-clip-text mb-6">{tourData.title}</h1>
        </div>
        ...
        <div className="flex justify-center mb-16">
          <p className="text-lg text-gray-300 text-justify lg:max-w-6xl">{tourData.fullDescription}</p>
        </div>
        ...
        {/* Exclusions Section */}
        <div className="mb-12 lg:w-1/2 backdrop-blur-sm bg-gray-900/50 rounded-xl p-6 border border-red-900/30">
          <h2 className="text-2xl font-bold text-red-500 mb-6 pb-2 border-b border-red-500/50">Exclusions</h2>
        ...
        <div className="mb-12 lg:w-1/2 backdrop-blur-sm bg-gray-900/50 rounded-xl p-6 border border-red-900/30">
          <h2 className="text-2xl font-bold text-red-500 mb-6 pb-2 border-b border-red-500/50">Terms and Conditions</h2>
          <ul className="space-y-4">
            <li className="text-gray-300 flex items-start">
              <span className="text-red-500 mr-2">•</span>
            ...
            <li className="text-gray-300 flex items-start">
              <span className="text-red-500 mr-2">•</span>
              <span>Cancellation up to 30 days before departure: 90% refund</span>
            </li>
            <li className="text-gray-300 flex items-start">
              <span className="text-red-500 mr-2">•</span>
            ...
            <li className="text-gray-300 flex items-start">
              <span className="text-red-500 mr-2">•</span>
              <span>The company reserves the right to change the itinerary due to unforeseen circumstances</span>
            </li>
            <li className="text-gray-300 flex items-start">
              <span className="text-red-500 mr-2">•</span>
            ...
            <li className="text-gray-300 flex items-start">
              <span className="text-red-500 mr-2">•</span>
              <span>The company is not responsible for any loss, injury, or damage to personal belongings</span>
            </li>
          </ul>
        </div>
      </div>
