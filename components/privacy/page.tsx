...
export default function PrivacyPolicy() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <Head>
        <title>Privacy Policy | Vetrivelan Travels</title>
        <meta
          name="description"
          content="Privacy Policy for Vetrivelan Travels services"
        />
      </Head>
      ...
      <main className="prose prose-lg">
        ...
        <section className="mb-6">
          ...
          <p>
            Vetrivelan Travels (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting
            your privacy. This Privacy Policy explains how we collect, use,
            disclose, and safeguard your information when you visit our website
            coimbatoretempotraveller.in or use our services.
          </p>
          <p>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              Fill out forms on our website (including name and phone number)
            </li>
          ...
          <p>
            <strong>2.2 Types of Information Collected:</strong>
          </p>
          <ul className="list-disc pl-6 mb-4">
            <li>
            ...
            <li>
              Booking details (travel dates, destinations, vehicle preferences)
            </li>
          ...
          <p>
            This information helps us analyze user behavior and improve our
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              ...
              business and deliver services to you.
            </li>
            <li>
        ...
        <section className="mb-6">
          ...
          <p>
            ...
            enhance your browsing experience. Cookies are small files placed on
            your device that allow us to analyze website traffic and customize
            content.
          </p>
          <p>
            You can set your browser to refuse all or some browser cookies or to
            alert you when cookies are being sent. However, some parts of our
            website may not function properly if you disable cookies.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            ...
            children. If you believe we have collected personal information from
            a child, please contact us immediately, and we will take steps to
